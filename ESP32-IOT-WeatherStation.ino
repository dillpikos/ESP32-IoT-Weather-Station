...
void setup() {
  ...
  //realTimeClock.adjust(DateTime(2025,6,16,14,30,0)); //sets time of module to June 16,2025 and 12:00:00 AM [setting time is based on 24 hours system] (upload once then comment out so RTC module keeps track of time)
